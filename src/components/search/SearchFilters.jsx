...
export default function SearchFilters({
  ...
  const isExtensionControlDisabled = isDisabled;
  const areOtherControlsDisabled = false;
    ...
    <section aria-labelledby="filters-heading">
      <div className="mb-4 bg-white p-6 rounded-lg shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Extension et groupe par extension - cachés en mode numéro */}
          <div className={`transition-all duration-200 ${isExtensionControlDisabled ? 'opacity-0 h-0 overflow-hidden my-0' : 'opacity-100'}`}>
        ...
        <div className="border-t border-gray-100 pt-6 space-y-4">
          <div className={`transition-all duration-200 ${isDisabled ? 'opacity-0 h-0 overflow-hidden my-0' : 'opacity-100'}`}>
          ...
          <fieldset className="space-y-2">
            <legend className="text-sm font-medium text-gray-700 mb-2">Filtrer par rareté</legend>
                    ...
                    <label
                      ...
                      className={`text-sm px-3 py-1.5 rounded-full border transition-colors cursor-pointer
                        ${areOtherControlsDisabled
                          ...
                          : isSelected
                            ? 'bg-indigo-100 text-indigo-800 border-indigo-200 peer-focus:ring-2 peer-focus:ring-indigo-500'
                            : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50 peer-focus:ring-2 peer-focus:ring-indigo-500'
                        }
                      `}
                    >
                      {rarity.replace('_', ' ')}
